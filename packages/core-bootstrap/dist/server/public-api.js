  ...
  "../core-exports/dist/server/public-api.js"(exports2, module2) {
    ...
    var require_public_api4 = __commonJS2({
      "../core-logger/dist/server/public-api.js"(exports22, module22) {
        ...
        var public_api_exports22 = {};
        __export22(public_api_exports22, {
          BaseLogger: () => BaseLogger,
          LOG_LEVELS: () => LOG_LEVELS,
          createCoreLogger: () => createCoreLogger2,
          formatLog: () => formatLog
        });
        module22.exports = __toCommonJS22(public_api_exports22);
        var LOG_LEVELS = {
          DEBUG: "debug",
          INFO: "info",
          WARN: "warn",
    ...
    module2.exports = __toCommonJS2(public_api_exports2);
    var import_public_api3 = __toESM2(require_public_api4());
    ...
    var logger = (0, import_public_api3.createCoreLogger)("core-exports");
...
__export(public_api_exports, {
  ...
  getBootstrapper: () => getBootstrapper,
  getFrameworkSnapshot: () => getFrameworkSnapshot,
  isFrameworkBootstrapped: () => isFrameworkBootstrapped,
  registerFrameworkModule: () => registerFrameworkModule,
  resolveModuleOrder: () => resolveModuleOrder,
  validateFrameworkKernelSnapshot: () => validateFrameworkKernelSnapshot,
  validateModuleDefinition: () => validateModuleDefinition,
  validateModuleLifecycleState: () => validateModuleLifecycleState,
  validateModuleState: () => validateModuleState,
  validateServiceRegistration: () => validateServiceRegistration
});
...
function registerFrameworkModule(definition) {
  if (bootstrapper.isBootstrapped()) {
    throw new import_core_errors4.InfrastructureError(
      "Cannot register framework module after bootstrap",
      {
        module: "core-bootstrap",
        code: import_core_errors4.ERROR_CODES.INFRASTRUCTURE_FAILURE,
...
function isFrameworkBootstrapped() {
