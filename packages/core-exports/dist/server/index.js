...
var require_infrastructure_error = __commonJS({
  "../core-errors/dist/infrastructure/infrastructure-error.js"(exports2) {
    ...
    var app_error_1 = require_app_error();
    var error_codes_1 = require_error_codes();
    var InfrastructureError3 = class extends app_error_1.AppError {
      constructor(message, details, cause) {
        super(message, error_codes_1.ERROR_CODES.INFRASTRUCTURE_FAILURE, details, cause);
      }
    };
    exports2.InfrastructureError = InfrastructureError3;
  }
});
...
var require_parse_dto = __commonJS({
  "../core-validation/dist/integration/parse-dto.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.parseDto = parseDto2;
    function parseDto2(schema7, input) {
      return schema7.parse(input);
    }
  }
});
...
// src/server/index.ts
var import_public_api2 = __toESM(require_public_api());

// src/server/runtime.ts
var import_public_api = __toESM(require_public_api());

// src/server/export-registry.ts
var import_core_errors = __toESM(require_dist());

// src/server/validate.ts
var import_core_validation7 = __toESM(require_dist2());

// src/server/schemas/custom-export-name-schema.ts
var import_core_validation = __toESM(require_dist2());
var CustomExportNameSchema = import_core_validation.schema.string().trim().min(1).regex(/^[a-z0-9-]+\.[A-Za-z][A-Za-z0-9]*$/, "Invalid custom export name");

// src/server/schemas/export-value-schema.ts
var import_core_validation2 = __toESM(require_dist2());
var ExportValueSchema = import_core_validation2.schema.custom(
  (value) => typeof value === "function" || value !== void 0,
  "Export value must be defined or be a function"
);

// src/server/schemas/qualified-export-name-schema.ts
var import_core_validation3 = __toESM(require_dist2());
var QualifiedExportNameSchema = import_core_validation3.schema.string().trim().min(1).refine(
  (value) => /^[a-z0-9-]+\.[A-Za-z][A-Za-z0-9]*$/.test(value) || /^[a-z0-9-]+\.service\.[a-z0-9-]+$/.test(value),
  "Invalid qualified export name"
);

// src/server/schemas/register-module-export-schema.ts
var import_core_validation4 = __toESM(require_dist2());
var RegisterModuleExportSchema = import_core_validation4.schema.object({
  moduleName: import_core_validation4.schema.string().trim().min(1).regex(/^[a-z0-9-]+$/, "Invalid module name"),
  exportName: import_core_validation4.schema.string().trim().min(1).regex(/^[A-Za-z][A-Za-z0-9]*$/, "Invalid export name"),
  value: import_core_validation4.schema.custom(
    (value) => typeof value === "function" || value !== void 0,
    "Export value must be defined or be a function"
  )
}).strict();

// src/server/schemas/register-public-service-schema.ts
var import_core_validation5 = __toESM(require_dist2());
var RegisterPublicServiceSchema = import_core_validation5.schema.object({
  moduleName: import_core_validation5.schema.string().trim().min(1).regex(/^[a-z0-9-]+$/, "Invalid module name"),
  serviceName: import_core_validation5.schema.string().trim().min(1).regex(/^[a-z0-9-]+$/, "Invalid service name"),
...
// src/server/schemas/service-export-name-schema.ts
var import_core_validation6 = __toESM(require_dist2());
var ServiceExportNameSchema = import_core_validation6.schema.string().trim().min(1).regex(/^[a-z0-9-]+\.service\.[a-z0-9-]+$/, "Invalid service export name");

// src/server/validate.ts
function validateQualifiedExportName(input) {
  return (0, import_core_validation7.parseDto)(QualifiedExportNameSchema, input);
}
function validateCustomExportName(input) {
  return (0, import_core_validation7.parseDto)(CustomExportNameSchema, input);
}
function validateServiceExportName(input) {
  return (0, import_core_validation7.parseDto)(ServiceExportNameSchema, input);
}
function validateExportValue(input) {
  return (0, import_core_validation7.parseDto)(ExportValueSchema, input);
}
function validateRegisterModuleExportInput(input) {
  return (0, import_core_validation7.parseDto)(RegisterModuleExportSchema, input);
}
function validateRegisterPublicServiceInput(input) {
  return (0, import_core_validation7.parseDto)(RegisterPublicServiceSchema, input);
}
...
var ExportRegistry = class {
  ...
  register(name, value) {
    ...
    if (this.exports.has(validatedName)) {
      throw new import_core_errors.InfrastructureError("Export is already registered", {
        module: "core-exports",
  ...
  resolve(name) {
    ...
    if (!entry) {
      throw new import_core_errors.InfrastructureError("Export not found", {
        module: "core-exports",
        code: import_core_errors.ERROR_CODES.INFRASTRUCTURE_FAILURE,
        exportName: name
      });
...
function buildQualifiedExportName(moduleName, exportName) {
...
var logger = (0, import_public_api.createCoreLogger)("core-exports");
...
function resolveService(name) {
  if (!name.includes(".service.")) {
    throw new import_core_errors2.InfrastructureError("Invalid service name", {
      module: "core-exports",
      code: import_core_errors2.ERROR_CODES.INFRASTRUCTURE_FAILURE,
      name
    });
  }
...
// src/server/index.ts
var logger2 = (0, import_public_api2.createCoreLogger)("core-exports");
...
logger2.info("core-exports started");
on("onResourceStart", (resourceName) => {
  if (resourceName !== GetCurrentResourceName()) {
    return;
  }
  try {
    logger2.info("resource boot confirmed");
    logger2.info("available services", {
