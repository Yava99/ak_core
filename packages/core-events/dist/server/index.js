...
var require_public_api = __commonJS({
  "../core-logger/dist/server/public-api.js"(exports2, module2) {
    ...
    __export2(public_api_exports, {
      ...
      createCoreLogger: () => createCoreLogger4,
      formatLog: () => formatLog
    });
    module2.exports = __toCommonJS2(public_api_exports);
    var LOG_LEVELS = {
      DEBUG: "debug",
      INFO: "info",
      WARN: "warn",
    ...
    function createCoreLogger4(context) {
...
var require_validation_error2 = __commonJS({
  "../core-validation/dist/errors/validation-error.js"(exports2) {
    ...
    var ValidationError2 = class extends core_errors_1.InfrastructureError {
    ...
    var TupleSchema = class extends base_schema_1.BaseSchema {
      ...
      _parse(context, input) {
        ...
        for (let i = 0; i < this.schemas.length; i++) {
          const schema2 = (0, get_array_item_1.getArrayItem)(this.schemas, i);
          const value = array[i];
          (0, schema_internal_1.pushPath)(context, i);
          const result = schema2["_parse"](context, value);
          (0, schema_internal_1.popPath)(context);
          if (!result.success) {
            return parse_status_1.FAIL;
          }
    ...
    var UnionSchema = class extends base_schema_1.BaseSchema {
      ...
      _parse(context, input) {
        ...
        for (let index = 0; index < this.schemas.length; index++) {
          const schema2 = (0, get_array_item_1.getArrayItem)(this.schemas, index);
          const branchContext = {
            path: [...context.path],
            issues: []
          };
          const result = schema2["_parse"](branchContext, input);
          if (result.success) {
...
var require_lazy_schema = __commonJS({
  "../core-validation/dist/schemas/lazy-schema.js"(exports2) {
    ...
    var LazySchema = class extends base_schema_1.BaseSchema {
      ...
      _parse(context, input) {
        const schema2 = this.getter();
        return schema2["_parse"](context, input);
      }
    };
...
var require_safe_parse = __commonJS({
  "../core-validation/dist/parsing/safe-parse.js"(exports2) {
    ...
    function safeParse(schema2, input) {
      return schema2.safeParse(input);
    }
  }
});
...
var require_assert_valid = __commonJS({
  "../core-validation/dist/parsing/assert-valid.js"(exports2) {
    ...
    function assertValid(schema2, input) {
      schema2.assert(input);
    }
  }
});
...
var require_parse_async = __commonJS({
  "../core-validation/dist/parsing/parse-async.js"(exports2) {
    ...
    async function parseAsync(schema2, input) {
      return schema2.parseAsync(input);
    }
  }
});
...
var require_safe_parse_async = __commonJS({
  "../core-validation/dist/parsing/safe-parse-async.js"(exports2) {
    ...
    async function safeParseAsync(schema2, input) {
      return schema2.safeParseAsync(input);
    }
  }
});
...
var require_parse_dto = __commonJS({
  "../core-validation/dist/integration/parse-dto.js"(exports2) {
    ...
    function parseDto(schema2, input) {
      return schema2.parse(input);
    }
  }
});
...
var require_parse_event_payload = __commonJS({
  "../core-validation/dist/integration/parse-event-payload.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.parseEventPayload = parseEventPayload3;
    function parseEventPayload3(schema2, payload) {
      return schema2.parse(payload);
    }
  }
});
...
var require_parse_config_section = __commonJS({
  "../core-validation/dist/integration/parse-config-section.js"(exports2) {
    ...
    function parseConfigSection(schema2, config) {
      return schema2.parse(config);
    }
  }
});
...
var LocalEventBus = class {
  ...
  onValidated(eventName, payloadSchema, handler) {
    assertValidLocalEventName(eventName);
    on(eventName, async (payload) => {
      try {
        const parsedPayload = (0, import_core_validation.parseEventPayload)(payloadSchema, payload);
        await handler(parsedPayload);
      } catch (error) {
        if (error instanceof import_core_validation.ValidationError) {
...
// src/server/net-event-bus.ts
var import_public_api2 = __toESM(require_public_api());
var import_core_validation2 = __toESM(require_dist2());
var logger2 = (0, import_public_api2.createCoreLogger)("core-events:net");
var NetEventBus = class {
  emitToClient(playerId, eventName, payload) {
    assertValidNetEventName(eventName);
    emitNet(eventName, playerId, payload);
  }
  onFromClient(eventName, handler) {
    assertValidNetEventName(eventName);
    onNet(eventName, (payload) => {
      const playerId = Number(global.source);
      handler(playerId, payload);
    });
  }
  onFromClientValidated(eventName, payloadSchema, handler) {
    assertValidNetEventName(eventName);
    onNet(eventName, async (payload) => {
      const playerId = Number(global.source);
      try {
        const parsedPayload = (0, import_core_validation2.parseEventPayload)(payloadSchema, payload);
        await handler(playerId, parsedPayload);
      } catch (error) {
        if (error instanceof import_core_validation2.ValidationError) {
          logger2.warn("net event payload validation failed", {
            eventName,
            playerId,
            formatted: error.format(),
            issues: error.issues,
...
var EventBus = class {
  constructor() {
    this.local = new LocalEventBus();
    this.net = new NetEventBus();
  }
};

// src/server/index.ts
var logger3 = (0, import_public_api3.createCoreLogger)("core-events");
var eventBus = new EventBus();
var coreEventsTestEvent = defineLocalEvent("core-events", "test");
var CoreEventsTestPayloadSchema = import_core_validation3.schema.object({
  message: import_core_validation3.schema.string().trim().min(1),
  value: import_core_validation3.schema.number(),
  active: import_core_validation3.schema.boolean()
}).strict();
logger3.info("core-events started");
on("onResourceStart", (resourceName) => {
  if (resourceName !== GetCurrentResourceName()) {
    return;
  }
  try {
    logger3.info("resource boot confirmed");
    eventBus.local.onValidated(coreEventsTestEvent, CoreEventsTestPayloadSchema, (payload) => {
      logger3.info("received core-events:test", { payload });
    });
