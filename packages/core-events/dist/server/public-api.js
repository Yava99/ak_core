    ...
    var TupleSchema = class extends base_schema_1.BaseSchema {
      ...
      _parse(context, input) {
        ...
        for (let i = 0; i < this.schemas.length; i++) {
          const schema = (0, get_array_item_1.getArrayItem)(this.schemas, i);
          const value = array[i];
          (0, schema_internal_1.pushPath)(context, i);
    ...
    var UnionSchema = class extends base_schema_1.BaseSchema {
      ...
      _parse(context, input) {
        ...
        for (let index = 0; index < this.schemas.length; index++) {
          const schema = (0, get_array_item_1.getArrayItem)(this.schemas, index);
          const branchContext = {
            path: [...context.path],
            issues: []
          };
...
var require_parse_event_payload = __commonJS({
  "../core-validation/dist/integration/parse-event-payload.js"(exports2) {
    ...
    function parseEventPayload3(schema, payload) {
...
var require_parse_config_section = __commonJS({
  "../core-validation/dist/integration/parse-config-section.js"(exports2) {
    ...
    function parseConfigSection(schema, config) {
...
__export(public_api_exports, {
  ...
  NetEventBus: () => NetEventBus,
  assertValidLocalEventName: () => assertValidLocalEventName,
  assertValidNetEventName: () => assertValidNetEventName,
  buildLocalEventName: () => buildLocalEventName,
  buildNetEventName: () => buildNetEventName,
  defineLocalEvent: () => defineLocalEvent,
  defineNetEvent: () => defineNetEvent
});
